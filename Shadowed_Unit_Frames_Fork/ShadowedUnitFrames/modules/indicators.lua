...
-- API Compatibility for WoW 2.5.5+
local GetLootMethod = C_LootInfo and C_LootInfo.GetLootMethod or GetLootMethod
local GetReadyCheckStatus = C_PartyInfo and C_PartyInfo.GetReadyCheckStatus or GetReadyCheckStatus
...
function Indicators:UpdateReadyCheck(frame, event)
	...
	if not GetReadyCheckStatus then
