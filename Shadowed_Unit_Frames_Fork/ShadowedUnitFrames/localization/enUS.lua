...
L["Language"] = "Language"
L["Overrides the language used by Shadowed Unit Frames. Useful for languages the WoW client does not support. Changing this reloads your interface."] = "Overrides the language used by Shadowed Unit Frames. Useful for languages the WoW client does not support. Changing this reloads your interface."
